...
def is_special_js_file(filename):
    patterns = [
        ...
        r'\.config\.js$',      # xxx.config.js
        r'\.setup\.js$',       # xxx.setup.js
        r'\.mock\.js$',        # xxx.mock.js
        r'\.controller\.js$',  # xxx.controller.js
        r'\.service\.js$',     # xxx.service.js
        r'\.model\.js$',       # xxx.model.js
        r'\.route\.js$',       # xxx.route.js
        r'\.middleware\.js$',  # xxx.middleware.js
        r'\.helper\.js$',      # xxx.helper.js
        r'\.util\.js$',        # xxx.util.js
        r'\.factory\.js$',     # xxx.factory.js
        r'\.validator\.js$',   # xxx.validator.js
        r'\.schema\.js$',      # xxx.schema.js
        r'\.env\.js$',         # xxx.env.js
        r'\.main\.js$',        # xxx.main.js
        r'\.init\.js$',        # xxx.init.js
    ]
    for pattern in patterns:
        if re.search(pattern, filename):
            return True
