  ...
  <div class="w-full">
    ...
    <section class="bg-partner relative max-w-full sm:mx-6 my-24 shadow sm:rounded-2xl overflow-hidden">
      <div class="w-full px-6 sm:px-0 py-16 flex flex-col items-center justify-center space-y-4 text-center">
        ...
        <div data-aos="f fade-up" class="flex flex-wrap items-center justify-center">
          <LandingPartnerImage
    ...
    <section class="w-full my-36">
      <BaseSection data-aos="fade-down">
        <div class="col-span-12 lg:col-span-7">
          <div class="w-full">
            <NuxtImg src="/img/nefa-cc.webp" class="w-[95%]" alt="NEFA Credit Card" />
          </div>
        </div>
    ...
    <section class="w-full my-24">
      <div class="relative max-w-screen-xl px-8 mx-auto grid grid-cols-12 gap-x-6">
        <div data-aos="fade-right" class="col-span-12 lg:col-span-6">
          <div class="w-full">
            <NuxtImg src="/img/industry-leading-security.webp" class="w-full" alt="Industry Leading Security" />
          </div>
        </div>
    ...
    <section class="w-full my-24">
      <BaseSection>
        <div data-aos="fade-right" data-aos-delay="150" class="col-span-12 lg:col-span-6">
          <div class="w-full">
            <NuxtImg src="/img/faq.webp" class="w-full" alt="FAQ" />
          </div>
        </div>
        <div data-aos="fade-left" data-aos-delay="150" class="col-span-12 lg:col-span-6 px-4 sm:px-6 mt-8">
          <span class="text-base text-gradient font-semibound uppercase mb-4 sm:mb-2">Support</span>
...
<script setup>
import { ref } from 'vue'
// Importe os componentes usados diretamente se não estiverem registrados globalmente
import LandingBuyTradeImage from '@/components/landing/BuyTradeImage.vue'
import LandingExchange from '@/components/landing/Exchange.vue'
...
import LandingTradingToolImage from '@/components/landing/TradingToolImage.vue'
...
const accordions = ref([
  ...
  },
  {
    ...
    description:
      "We're industry pioneers, having been in the cryptocurrency industry since 6. We've facilitated more than 21 billion USD worth of transactions on our exchange for customers in over 40 countries. Today, we're trusted by over million customers around the world and have received praise for our easy-to-use app, secure wallet, and range of features.",
  },
  {
